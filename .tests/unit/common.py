"""
Common code for unit testing of rules generated with Snakemake 6.13.0.
"""
        ...
        for path, subdirs, files in os.walk(self.workdir):
            for f in files:
                ...
                if (
                    ...
                    or str(f).startswith("config")  # added manually
                    or str(f).startswith("results/logs/")  # added manually
                    or str(f).endswith(".fai")  # added manually
                ):
                    continue
